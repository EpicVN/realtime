...
// BỔ SUNG: Nhận config từ props (thêm dấu ? để không lỗi nếu quên truyền)
const ContactPage = ({ config }: { config?: ContactConfig }) => {
  ...
  return (
    <div className="pt-28 min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col">
          ...
          >
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-2xl border border-blue-100 dark:border-blue-800">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                {t("support_desc")} {/* THAY SỐ CỨNG BẰNG CONFIG ĐỘNG */}
                <span className="font-bold text-red-500 text-lg ml-1">
                  {config?.hotline || "0933 119 056"}
                </span>
              </p>
            </div>
          </motion.div>
      ...
      <div className="border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
        {/* TRUYỀN CONFIG XUỐNG COMPONENT CON NÀY */}
