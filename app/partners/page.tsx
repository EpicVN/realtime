...
const PARTNERS = [
  {
    ...
    logos: [
      ...
      { name: "CMC Telecom", img: "/images/partners/cmc.png", scale: 2.4 },
    ],
  },
  {
    ...
    logos: [
      ...
      { name: "Tìm việc 365", img: "/images/partners/myjob365.png", scale: 2.4 },
      { name: "Hùng Cường", img: "/images/partners/hungcuong.png", scale: 2 },
      { name: "Findjobs", img: "/images/partners/findjobs.png", scale: 0.8 },
      { name: "Cửa Sổ Vàng", img: "/images/partners/cuasovang.png", scale: 1.6 },
    ],
  },
];
...
const BENEFITS = [
  {
    ...
    desc: "Cam kết đồng hành lâu dài, chia sẻ lợi nhuận hấp dẫn và hỗ trợ kỹ thuật 24/7 cho mọi đối tác.",
  },
  {
    icon: <FaChartLine />,
    title: "Tăng trưởng doanh thu",
    desc: "Mở rộng danh mục sản phẩm của bạn với các giải pháp VoIP & CRM hàng đầu, giúp gia tăng doanh số nhanh chóng.",
  },
  {
    icon: <FaGlobe />,
    title: "Mở rộng thị trường",
    desc: "Tiếp cận mạng lưới khách hàng doanh nghiệp rộng lớn nhờ uy tín thương hiệu của Realtime Solutions.",
  },
];
      ...
      <div className="container mx-auto px-6 text-center mb-20">
        ...
        >
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
            Đối tác chiến lược của <br />
            <span className="text-blue-600">Realtime Solutions</span>
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Chúng tôi tự hào được đồng hành cùng các doanh nghiệp hàng đầu tại
            Việt Nam và khu vực, kiến tạo giải pháp giao tiếp vượt trội.
          </p>
        </motion.div>
      </div>
      ...
      <div className="w-full mb-24 space-y-20 container mx-auto px-6">
        {PARTNERS.map((group, groupIndex) => (
          <div key={groupIndex} className="relative">
            ...
            {/* --- MARQUEE CONTAINER --- 
               Sử dụng mask-image để làm mờ 2 bên cạnh trái phải
            */}
            <div className="flex overflow-hidden relative w-full mask-[linear-gradient(to_right,transparent,white_10%,white_90%,transparent)]">
              <motion.div
                ...
                // Logic: Di chuyển từ 0% đến -50% (vì ta nhân đôi mảng logo bên dưới)
                animate={{ x: "-50%" }}
                transition={{
              ...
              >
                {/* Nhân bản danh sách logo lên 4 lần để đảm bảo chạy kín màn hình lớn 
                   (Double array technique for infinite loop)
                */}
                {[
                  ...group.logos,
                  ...group.logos,
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">
              Tại sao chọn hợp tác với Realtime?
            </h2>
            <p className="text-blue-100 max-w-2xl mx-auto">
              Hệ sinh thái công nghệ toàn diện giúp bạn đi nhanh hơn và xa hơn.
            </p>
          </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-400 dark:text-gray-600 mb-8 max-w-xl mx-auto">
              Đăng ký ngay để nhận chính sách ưu đãi dành riêng cho đại lý và
              đối tác chiến lược.
            </p>
            <Link
              href="/contact"
